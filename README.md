...
[![Travis](https://img.shields.io/travis/trisztan/laravel-barion.svg?style=flat-square)](https://travis-ci.org/trisztan/laravel-barion)
...
[![Packagist](https://img.shields.io/packagist/v/trisztan/laravel-barion.svg?style=flat-square)](https://packagist.org/packages/trisztan/laravel-barion)
...
`composer require trisztan/laravel-barion`

2. Register the service provider in the `app.php` config file

```php
trisztan\Barion\BarionServiceProvider::class,
```

3. Register the Barion facade (optional)

```php
'Barion' =>  trisztan\Barion\BarionFacade::class
```
...
Laravel-Barion comes preconfigured, you only need to set your POS key in the
 ...
 `artisan vendor:publish --provider="trisztan\Barion\BarionServiceProvider"`
